...
PROJECT=$(curl -X GET -G --data-urlencode "name=$GITHUB_REPOSITORY" "https://dependencytrack.bymiles.co.uk/api/v1/project?excludeInactive=true" -H  "accept: application/json" -H  "X-Api-Key: $DTRACK_KEY")
